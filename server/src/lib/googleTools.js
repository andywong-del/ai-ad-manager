...
export const googleTools = [
  ...
  T('google_add_keywords', 'Add keywords to a Google Ads ad group. ALWAYS confirm with user before calling.', addKeywords, obj({ adGroupId: str('Ad group ID'), keywords: { type: 'array', description: 'Array of keyword objects', items: { type: 'object', properties: { text: { type: 'string' }, matchType: { type: 'string', description: 'EXACT, PHRASE, or BROAD' }, cpcBidMicros: { type: 'number' } }, required: ['text', 'matchType'] } }, accountId: str('Customer ID (optional)'), loginCustomerId: str('MCC login ID (optional)') }, ['adGroupId', 'keywords'])),
  T('google_add_negative_keywords', 'Add negative keywords to block unwanted search terms. ALWAYS confirm with user before calling.', addNegativeKeywords, obj({ level: { type: 'string', description: 'campaign or adGroup' }, campaignId: str('Campaign ID (for campaign level)'), adGroupId: str('Ad Group ID (for adGroup level)'), keywords: { type: 'array', description: 'Array of negative keyword objects', items: { type: 'object', properties: { text: { type: 'string' }, matchType: { type: 'string', description: 'EXACT, PHRASE, or BROAD' } }, required: ['text', 'matchType'] } }, accountId: str('Customer ID (optional)'), loginCustomerId: str('MCC login ID (optional)') }, ['level', 'keywords'])),
  T('google_set_campaign_targeting', 'Set campaign targeting: geo locations, devices, or languages. ALWAYS confirm with user before calling.', setCampaignTargeting, obj({ campaignId: str('Campaign ID'), targetingType: { type: 'string', description: 'geo, devices, or languages' }, geoTargets: { type: 'array', description: 'For geo targeting', items: { type: 'object', properties: { geoTargetConstantId: { type: 'string' }, isNegative: { type: 'boolean' }, bidModifier: { type: 'number' } }, required: ['geoTargetConstantId'] } }, devices: { type: 'array', description: 'For device targeting', items: { type: 'object', properties: { type: { type: 'string', description: 'MOBILE, DESKTOP, or TABLET' }, bidModifier: { type: 'number' } }, required: ['type'] } }, languageCodes: { type: 'array', description: 'ISO language codes like en, zh', items: { type: 'string' } }, accountId: str('Customer ID (optional)'), loginCustomerId: str('MCC login ID (optional)') }, ['campaignId', 'targetingType'])),
  T('google_create_website_visitors_audience', 'Create a remarketing list for website visitors. ALWAYS confirm with user before calling.', createWebsiteVisitorsAudience, obj({ name: str('Audience name'), urlRules: { type: 'array', description: 'URL matching rules', items: { type: 'object', properties: { type: { type: 'string', description: 'EQUALS or CONTAINS' }, value: { type: 'string', description: 'URL to match' } }, required: ['type', 'value'] } }, membershipLifeSpanDays: num('Days to keep users (default 30)'), accountId: str('Customer ID (optional)'), loginCustomerId: str('MCC login ID (optional)') }, ['name', 'urlRules'])),
  T('google_create_custom_audience', 'Create a custom audience based on keywords, URLs, or apps. ALWAYS confirm with user before calling.', createCustomAudience, obj({ name: str('Audience name'), type: { type: 'string', description: 'SEARCH or INTEREST' }, members: { type: 'array', description: 'Audience member definitions', items: { type: 'object', properties: { memberType: { type: 'string', description: 'KEYWORD, URL, or APP' }, value: { type: 'string' } }, required: ['memberType', 'value'] } }, accountId: str('Customer ID (optional)'), loginCustomerId: str('MCC login ID (optional)') }, ['name', 'type', 'members'])),
