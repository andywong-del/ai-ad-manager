        ...
        {!token ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-16 h-16 rounded-2xl bg-violet-50 flex items-center justify-center mb-4">
              <Settings2 size={28} className="text-violet-300" />
            </div>
            <p className="text-sm font-semibold text-slate-700 mb-1">Connect an ad platform to manage automation rules</p>
            <p className="text-xs text-slate-400 mb-5 max-w-xs mx-auto text-center">Log in with Meta, Google, or TikTok to create and manage your automation rules.</p>
